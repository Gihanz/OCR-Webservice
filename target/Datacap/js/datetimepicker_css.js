...
var SpanBorderColor = "#B1B1B1";//span border color
var SpanBgColor = "#E9E9E9"; //span background color
var MonthYearColor = "#152766"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#9DA0A2"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#9DA0A2"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#9DA0A2"; //Background color of Saturday.
var WeekDayColor = "#DDDEE0"; //Background color of weekdays.
var FontColor = "Blue"; //color of font in Calendar day cell.
var TodayColor = "#A2BEC4"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#E8EAEE"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#93C6F3"; //color when mouse move over.
...
//var imageFilesPath = CONTEXT_ROOT+"/images/";
...
function RenderCssCal(bNewCal)
{
	...
	else
	{
		...
		if (bNewCal === true)
		{
			...
			/*winCal.style.left = '488px';*/
			winCal.style.top =  '306px';
			/*
			winCal.style.left = (xpos + CalPosOffsetX) + 'px';
	...
	function validateDates(txtId){	
	 ...
	 if(value.length>0){
		if(!isValidDate(value,'yyyy-mm-dd')){		   
		   ...
		   setMessageDialog(validationTitle,"<span >Please enter a valid date</span>");
